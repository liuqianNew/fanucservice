  ...
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://fanuc.com.cn/">
      ...
      <s:element name="GetFDIPostWOIssueDetailByPageResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetFDIPostWOIssueDetailByPageResult" type="tns:ArrayOfFDIPostWOIssueDetail" />
          </s:sequence>
        </s:complexType>
      </s:element>
      ...
      <s:element name="AddFDIPostWOIssueDetail">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="mFDIPostWOIssueDetail" type="tns:FDIPostWOIssueDetail" />
          </s:sequence>
        </s:complexType>
      </s:element>
      ...
      <s:element name="GetFDIPostWOIssueDetailsResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetFDIPostWOIssueDetailsResult" type="tns:ArrayOfFDIPostWOIssueDetail" />
          </s:sequence>
        </s:complexType>
      </s:element>
      ...
      <s:element name="GetFDIPostWOIssueDetailByIdResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetFDIPostWOIssueDetailByIdResult" type="tns:FDIPostWOIssueDetail" />
          </s:sequence>
        </s:complexType>
      </s:element>
