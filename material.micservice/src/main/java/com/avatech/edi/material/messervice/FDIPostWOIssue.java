...
/**
 * <p>FDIPostWOIssue complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="FDIPostWOIssue">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Details" type="{http://fanuc.com.cn/}ArrayOfFDIPostWOIssueDetail" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FDIPostWOIssue", propOrder = {
    "pkno",
    "docDate",
    "docEntry",
    "comments",
...
public class FDIPostWOIssue {
    ...
    protected ArrayOfFDIPostWOIssueDetail details;
     ...
     *     
     */
    public ArrayOfFDIPostWOIssueDetail getDetails() {
        return details;
    }
     ...
     *     
     */
    public void setDetails(ArrayOfFDIPostWOIssueDetail value) {
        this.details = value;
    }
