...
/**
 * <p>FDIPostWOIssueDetail complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="FDIPostWOIssueDetail">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Batchs" type="{http://fanuc.com.cn/}ArrayOfFDIPostWOIssueBatch" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FDIPostWOIssueDetail", propOrder = {
    "pkno",
    "docEntry",
    "lineId",
    "itemCode",
...
public class FDIPostWOIssueDetail {
    ...
    protected ArrayOfFDIPostWOIssueBatch batchs;
     ...
     *     
     */
    public ArrayOfFDIPostWOIssueBatch getBatchs() {
        return batchs;
    }
     ...
     *     
     */
    public void setBatchs(ArrayOfFDIPostWOIssueBatch value) {
        this.batchs = value;
    }
