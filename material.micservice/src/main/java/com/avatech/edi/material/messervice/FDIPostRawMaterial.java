...
/**
 * <p>FDIPostRawMaterial complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="FDIPostRawMaterial">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Details" type="{http://fanuc.com.cn/}ArrayOfFDIPostRawMaterialDetail" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FDIPostRawMaterial", propOrder = {
    "pkno",
    "cardCode",
    "cardName",
    "docType",
...
public class FDIPostRawMaterial {
    ...
    protected ArrayOfFDIPostRawMaterialDetail details;
     ...
     *     
     */
    public ArrayOfFDIPostRawMaterialDetail getDetails() {
        return details;
    }
     ...
     *     
     */
    public void setDetails(ArrayOfFDIPostRawMaterialDetail value) {
        this.details = value;
    }
