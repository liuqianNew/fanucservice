...
/**
 * <p>FDIGetWOrderDetail complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="FDIGetWOrderDetail">
 *   &lt;complexContent>
 ...
 *         &lt;element name="BaseQty" type="{http://www.w3.org/2001/XMLSchema}decimal"/>
...
@XmlType(name = "FDIGetWOrderDetail", propOrder = {
    "pkno",
    "docEntry",
    "lineNum",
    "itemCode",
...
public class FDIGetWOrderDetail {
    ...
    @XmlElement(name = "BaseQty", required = true, nillable = true)
